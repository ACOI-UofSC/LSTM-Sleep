...
from preprocessing.heart_rate.heart_rate_collection import HeartRateCollection
...
class HeartRateService(object):
    ...
    def write(heart_rate_collection):
        ...
        np.savetxt(hr_output_path, heart_rate_collection.data, fmt='%f', delimiter=',')
    ...
    def get_raw_file_path(subject_id):
        return Constants.HR_FILE_PATH.joinpath(subject_id + '_heart_rate.csv')
